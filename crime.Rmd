...
This page focuses on analyses that pertain to understanding crime in Phoenix:  
  ...
  * [What is going on with crime in Phoenix? (well, let's look!)](https://jacobtnyoung.github.io/OpenCrimPhx/docs/crime-trends.html)  
  * [(More on) What is going on with crime (**types**) in Phoenix?](https://jacobtnyoung.github.io/OpenCrimPhx/docs/crime-types.html)
