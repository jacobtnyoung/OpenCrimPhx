...
Next, we will load the data. These files are available in the [data](https://jacobtnyoung.github.io/OpenCrimPhx/docs/data) folder for the repository.
...
# define the objects
crimeData       <- readRDS( here( "docs/data/crimeData.rds" ) )
crimesByDay     <- readRDS( here( "docs/data/crimesByDay.rds" ) )
crimesByMonth   <- readRDS( here( "docs/data/crimesByMonth.rds" ) )
crimesByYear    <- readRDS( here( "docs/data/crimesByYear.rds" ) )
crimeRatesMonth <- readRDS( here( "docs/data/crimeRatesMonth.rds" ) )
crimeRatesYear  <- readRDS( here( "docs/data/crimeRatesYear.rds" ) )

crimeRatesMonthType  <- readRDS( here( "docs/data/crimeRatesMonthType.rds" ) )
