...
# crimes by type
saveRDS( crimesByTypeByMonth, file = here( "data/data-rodeo/crimesByTypeByMonth.rds" ) )
saveRDS( crimesByTypeByYear , file = here( "data/data-rodeo/crimesByTypeByYear.rds" ) )
saveRDS( crimeRatesMonthType, file = here( "data/data-rodeo/crimeRatesMonthType.rds" ) )
saveRDS( crimeRatesYearType , file = here( "data/data-rodeo/crimeRatesMonthYear.rds" ) )
