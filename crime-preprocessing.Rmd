...
import::here( "phoenixPopDat",
              .from = here::here( "docs/utils/phoenix-population.R" ),
              .character_only = TRUE )
...
# get the file
crimeDatGeo <- readRDS( here( "docs/data/data-geo/crimeDatGeo2016-2024.rds" ) )
...
saveRDS( crimeData,       file = here( "docs/data/crimeData.rds" ) )
saveRDS( crimesByDay,     file = here( "docs/data/crimesByDay.rds" ) )
saveRDS( crimesByMonth,   file = here( "docs/data/crimesByMonth.rds" ) )
saveRDS( crimesByYear,    file = here( "docs/data/crimesByYear.rds" ) )
saveRDS( crimeRatesMonth, file = here( "docs/data/crimeRatesMonth.rds" ) )
saveRDS( crimeRatesYear,  file = here( "docs/data/crimeRatesYear.rds" ) )

# crimes by type
saveRDS( crimesByTypeByMonth, file = here( "docs/data/crimesByTypeByMonth.rds" ) )
saveRDS( crimesByTypeByYear , file = here( "docs/data/crimesByTypeByYear.rds" ) )
saveRDS( crimeRatesMonthType, file = here( "docs/data/crimeRatesMonthType.rds" ) )
saveRDS( crimeRatesYearType , file = here( "docs/data/crimeRatesMonthYear.rds" ) )


```

If you look in the [data](https://jacobtnyoung.github.io/OpenCrimPhx/docs/data) folder for the repository, you will see that these files have been added. When I run this script, I have to push these files to the repository. But, we can now reference them using the `readRDS()` function.
